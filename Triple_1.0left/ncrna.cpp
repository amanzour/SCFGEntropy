...
int main (int argc, char * argv[])
{
	...
	double temp, threshold=-100;
	istringstream istr,istr4;
	string seq_grammar, seqstr="AAAUUUUUUUUAAAAAAAAAUUUUUUUUAAAAAAAAAUUUUUUUU";
...
//	int temp_nu_i, temp_nu_j; // for the loop of output bp matrix
	...
	//	seq_filename = "../../../debug/test.txt";
	//	seq_grammar = "../../../debug/grammar.txt";
	//	matrix_filename = "../../../debug/bpvector.txt";
	//	vector_filename = "../../../debug/nvector.txt";
	...
	//for (i=0; i<=10; i++)
	    {
	    	...
	    	//cout<<temp<<endl;
			//cout<<entro.inout.alpha(0,0,winwidth-1).Sci2Double()<<endl;
                cout<<temp<<endl; //for outputting entropy
                //cout<<entro.maxEntropy(winwidth)<<endl;
	    }
