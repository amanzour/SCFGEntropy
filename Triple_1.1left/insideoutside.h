...
public:
	...
	scidouble alpha_left(int v, int i, int j); // return result of inside algorithm from alphamatrix_left
	scidouble beta_left(int v, int i, int j); // return result of outside algorithm from betamatrix_left
	...
	scidouble basepair(int i, int j, const string &str);
        //amir
        scidouble qprob(int posi, const string &qstr);
        //amir done
...
private:
	...
	vector< vector< vector<scidouble> > > alphamatrix_left; // alpha_left matrix
	vector< vector< vector<scidouble> > > betamatrix_left; // alpha_left matrix	
